...
var sslOptions = {
    cert: fs.readFileSync('./cert/localhost_cert.pem'),
    ca: fs.readFileSync('./cert/localhost_cert.pem'),
    rejectUnauthorized: false
};

var CtrlClient = require('./client-lib');

var ctrlClient = new CtrlClient(9001, 'localhost', sslOptions, false);

var sessionOptions = {
    'authToken': 'fiBBBpb2PRbpbSAwQ6X1Wt2gUeewzqCFz583k9T1RWgTDHgkE4',
